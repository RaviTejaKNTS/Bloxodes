...
function printUsage() {
  console.log(
    "Usage: npm run articles:queue:update -- --queue-id UUID --status processing|completed|published|rejected|skipped|failed --apply [--worker NAME] [--reason TEXT] [--result-path final.json] [--result-slug SLUG] [--production-url URL]"
  );
}
