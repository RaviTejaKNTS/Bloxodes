---
name: bloxodes-tool-suggestions
description: Suggest Bloxodes tool page opportunities for one Roblox game or Roblox platform topic. Use when the user asks what calculators, planners, trackers, converters, or interactive tools can be built.
---
