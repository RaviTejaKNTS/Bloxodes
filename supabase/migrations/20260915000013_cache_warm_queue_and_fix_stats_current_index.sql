-- Historical migration version consolidated to keep one file per version.
-- Both sections were deployed under version 20260915000013 before the
-- repository enforced unique migration timestamps.
