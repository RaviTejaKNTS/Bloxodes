...
type RuntimeMode = "database-only";
...
export function requiresWikiCollectionDatabase(_code: string): boolean {
  return true;
}

export function shouldFallbackToLocalWikiCollectionData(_code?: string): boolean {
  return false;
}
