...
const COLLECTION_FOCUS: Record<string, string> = {
  ...
  classes: "class costs, rarity labels, run roles, kits, and solo or team unlock value",
  ...
  weapons: "slot, type, unlock route, costs, default state, mode-exclusive notes, and contracts",
