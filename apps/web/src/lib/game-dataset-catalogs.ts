...
const COLLECTION_FOCUS: Record<string, string> = {
  ...
  auras: "aura names, costs, source, availability, effect confidence, and upgrade context",
  ...
  trails: "trail names, costs, source, availability, effect confidence, and equip context",
