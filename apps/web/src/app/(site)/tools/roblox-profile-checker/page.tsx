...
import { RobloxProfileCheckerClient } from "./RobloxProfileCheckerClient";
...
const TOOL_CODE = "roblox-profile-checker";
...
export default async function RobloxProfileCheckerPage() {
  const tool = await getToolContentWithDevFallback(TOOL_CODE);
    ...
    <>
      ...
      <header className="space-y-3">
        <h1 className="text-4xl font-semibold leading-tight text-foreground md:text-5xl">
          {tool?.title ?? "Roblox Profile Checker"}
        </h1>
