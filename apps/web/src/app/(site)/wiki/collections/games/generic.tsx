...
type CollectionSectionOverride = {
  groupKey: string;
  groupLabel: string;
  sectionOrder: string[];
  getSectionLabel: (item: GameCollectionItem) => string | null;
  hiddenKeys?: string[];
  ...
  subtitleKeys?: string[];
  fieldPresentation?: Record<string, CollectionFieldPresentation | CollectionFieldKind>;
  transformItem?: (item: GameCollectionItem) => GameCollectionItem;
  transformItems?: (items: GameCollectionItem[]) => GameCollectionItem[];
};
...
function firstJujutsuValue(item: GameCollectionItem, keys: string[]): string | null {
...
function withJujutsuCardSummary(keys: string[]) {
  return (item: GameCollectionItem): GameCollectionItem => ({
    ...item,
...
const CATALOG_SECTION_OVERRIDES: Record<string, CollectionSectionOverride> = {
  ...
  "demonology-equipment": {
    ...
    additionalColumns: ["collectionSection"],
    maxStats: 5
  },
  "demonology-maps": {
    groupKey: "collectionSection",
  ...
  "demonology-cursed-objects": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["slug", "collectionSection", "sourceConfidence", "verificationNote", "sourcePage"],
    additionalColumns: ["collectionSection", "cardSummary"],
    maxStats: 6
  },
  "demonology-perks": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["slug", "collectionSection", "category", "sourceImageUrl", "sourcePage", "sortOrder"],
    additionalColumns: ["collectionSection", "cardSummary"],
    maxStats: 4
  },
  "anime-squadron-equipment": {
    ...
    getSectionLabel: (item) => normalizeValue(item.collectionSection) ?? "Other",
  ...
  "sell-lemons-powers": {
    ...
    getSectionLabel: (item) => normalizeValue(item.collectionSection) ?? "Other",
    hiddenKeys: ["collectionSection", "phase", "order", "unlock", "resetNote", "sourceConfidence", "verificationNote", "imageStatus", "sourcePage"],
    additionalColumns: ["collectionSection"],
    maxStats: 3,
    subtitleKeys: []
  },
  ...
  "sell-lemons-evolution-stages": {
    ...
    getSectionLabel: (item) => normalizeValue(item.collectionSection) ?? "Current fruit stages",
    hiddenKeys: [
      "collectionSection",
      "stageOrder",
      "sourceStatus",
  ...
  "sell-lemons-locations": {
    ...
    getSectionLabel: (item) => normalizeValue(item.collectionSection) ?? "Other",
    hiddenKeys: ["collectionSection", "sortOrder", "keyObjectsOrNpcs", "rewardOrReason", "verification"],
    additionalColumns: ["collectionSection"],
    maxStats: 4,
    subtitleKeys: []
  },
  ...
  "1-speed-keyboard-escape-stages": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "imageStatus", "sortOrder", "sourcePage", "secondarySourcePage", "sourceStatus"],
    maxStats: 4,
    hideImages: true
  },
  ...
  "rivals-skins": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "imageStatus", "sourcePage", "wikiUrl", "sourceImageUrl", "verificationNote"],
    additionalColumns: ["collectionSection"],
    maxStats: 6
  },
  "rivals-wraps": {
  ...
  "jujutsu-shenanigans-achievements": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", ...JUJUTSU_SHENANIGANS_VERBOSE_CARD_KEYS, "sourcePage", "wikiUrl", "verificationNote"],
    additionalColumns: ["collectionSection", "cardSummary"],
    maxStats: 5,
    hideImages: true,
    subtitleKeys: [],
  ...
  "99-nights-in-the-forest-crafting": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "ingredients", ...NINETY_NINE_NIGHTS_SOURCE_KEYS],
    maxStats: 5
  },
  "99-nights-in-the-forest-entities": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", ...NINETY_NINE_NIGHTS_SOURCE_KEYS],
    maxStats: 5
  },
  ...
  "survive-zombie-arena-classes": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "availability", ...SURVIVE_ZOMBIE_ARENA_SOURCE_KEYS],
    maxStats: 7
  },
  ...
  "survive-zombie-arena-gear": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", ...SURVIVE_ZOMBIE_ARENA_SOURCE_KEYS],
    maxStats: 7
  },
  ...
  "murderers-vs-sheriffs-modes": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "placeId", "sourceStatus", "sourceUrls", "sourceCheckedAt", "verificationNote"],
  ...
  "murderers-vs-sheriffs-bundles": {
    ...
    additionalColumns: ["price", "contents", "itemTypes", "availability", "source", "relatedCollections"],
    maxStats: 6
  },
  ...
  "wizard-alchemy-materials": {
    ...
    getSectionLabel: (item) => normalizeValue(item.collectionSection) ?? null,
    hiddenKeys: ["collectionSection"],
    additionalColumns: ["collectionSection"],
    maxStats: 6
  },
  ...
  "wizard-alchemy-races": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "alternateName", "confidence", "verificationNote"],
    additionalColumns: ["collectionSection"],
    maxStats: 8
  },
  "wizard-alchemy-wands": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "priceGold", "verificationNote"],
    additionalColumns: ["collectionSection"],
    maxStats: 6
  },
  "wizard-alchemy-brooms": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "priceCoins", "sourceImageUrl"],
    additionalColumns: ["collectionSection"],
    maxStats: 6
  },
  ...
  "wizard-alchemy-chests": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "verificationNote"],
    additionalColumns: ["collectionSection"],
    maxStats: 8
  },
  "wizard-alchemy-enemies": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "family", "verificationNote"],
    additionalColumns: ["collectionSection"],
    maxStats: 8
  },
  ...
  "slime-rng-slimes": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "sortOrder", "sourcePage", "sourceImageUrl"],
    additionalColumns: ["collectionSection"],
    maxStats: 6
  },
  "slime-rng-zones": {
  ...
  "slime-rng-power-fruits": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "spawnChanceDenominator", "sortOrder", "sourcePage", "sourceImageUrl"],
    additionalColumns: ["collectionSection"],
    maxStats: 6
  },
  "slime-rng-rebirths": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "rebirthRange", "resetNote", "sortOrder", "sourcePage", "sourceImageUrl"],
    additionalColumns: ["collectionSection"],
    maxStats: 3,
    hideImages: true
  },
  "slime-rng-index-rewards": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "sortOrder", "sourcePage", "rewardSummary"],
    additionalColumns: ["collectionSection"],
    maxStats: 5,
    hideImages: true
  },
  ...
  "kick-a-lucky-block-mutations": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "sortOrder", "sourcePage", "sourceStatus"],
    additionalColumns: ["collectionSection"],
    maxStats: 4
  },
  ...
  "kick-a-lucky-block-weights": {
    ...
    getSectionLabel: getCollectionSection,
    hiddenKeys: ["collectionSection", "sortOrder", "sourcePage", "sourceImageUrl", "sourceStatus"],
    additionalColumns: ["collectionSection"],
    maxStats: 4
  },
  ...
  "violence-district-currency": {
    ...
    fieldPresentation: {
      ...
      source: { kind: "normal", label: "Source" },
      obtainment: { kind: "detail", label: "Obtainment" },
      shop: { kind: "normal", label: "Shop" },
      mainUse: { kind: "normal", label: "Main use" },
      rewardRate: { kind: "detail", label: "Reward rate" },
      spendingPriority: { kind: "normal", label: "Spending priority" }
    }
  }
};
...
function getCategorySection(item: GameCollectionItem): string | null {
  return normalizeValue(item.category);
}

function getTierSection(item: GameCollectionItem): string | null {
  return normalizeValue(item.tier);
}

function getSeaSection(item: GameCollectionItem): string | null {
  return normalizeValue(item.sea);
}

function getCollectionSection(item: GameCollectionItem): string | null {
  return normalizeValue(item.collectionSection);
}

function withRivalsCharmFields(item: GameCollectionItem): GameCollectionItem {
...
function getBossStage(item: GameCollectionItem): string | null {
  return normalizeValue(item.bossStage);
}

function getTitleRoleSection(item: GameCollectionItem): string | null {
  return normalizeValue(item.titleRole ?? item.category);
}

function withDisplayRarity(item: GameCollectionItem): GameCollectionItem {
...
function withBloxFruitsAccessoryFields(item: GameCollectionItem): GameCollectionItem {
  const bonusParts = getBloxFruitsBonusParts(item);

  return {
    ...item,
    collectionSection: getBloxFruitsAccessorySection(item),
...
function getBloxFruitsAccessorySection(item: GameCollectionItem): string | null {
...
function getBloxFruitsAccessorySeaLabel(item: GameCollectionItem): string | null {
  const sea = normalizeValue(item.sea)?.toLowerCase() ?? "";
  if (!sea) return null;
...
function getBloxFruitsBonusParts(item: GameCollectionItem): string[] {
...
function withBloxFruitsFruitFields(item: GameCollectionItem): GameCollectionItem {
  const status = getBloxFruitsFruitStatus(item);
  const baseFruit = getBloxFruitsMutationBaseFruit(item);

  return {
    ...item,
    collectionSection: getBloxFruitsFruitSection(item),
...
function getBloxFruitsFruitSection(item: GameCollectionItem): string | null {
...
function getBloxFruitsFruitStatus(item: GameCollectionItem): string {
  const unavailableReason = normalizeValue(getBloxFruitsFieldValue(item, "unavailableReason"));
...
function getBloxFruitsMutationBaseFruit(item: GameCollectionItem): string | null {
...
function withBloxFruitsSwordFields(item: GameCollectionItem): GameCollectionItem {
  return {
    ...item,
    collectionSection: getBloxFruitsSwordSection(item),
...
function getBloxFruitsSwordSection(item: GameCollectionItem): string | null {
  const sea = normalizeValue(item.sea)?.toLowerCase() ?? "";
...
function getBloxFruitsSwordSourceRoute(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsSwordCost(item: GameCollectionItem): string | null {
  return formatBloxFruitsMoney(item.money) ?? formatBloxFruitsRobux(item.robux);
}

function getBloxFruitsSwordProgressionUse(item: GameCollectionItem): string | null {
...
function withBloxFruitsFightingStyleFields(item: GameCollectionItem): GameCollectionItem {
  const name = normalizeValue(item.name) ?? "";
  const details = getBloxFruitsFightingStyleDetails(name);

  return {
    ...item,
    collectionSection: details.section,
...
function getBloxFruitsTeacherFromType(item: GameCollectionItem): string | null {
  const type = normalizeValue(item.type);
  if (!type || type === "Source N/A") return null;
  return type.replace(/^Source\s+/i, "").trim() || null;
}

function withBloxFruitsMaterialFields(item: GameCollectionItem): GameCollectionItem {
  return {
    ...item,
    collectionSection: getBloxFruitsMaterialSection(item),
    displaySea: getBloxFruitsSeaLabel(item.sea),
...
function getBloxFruitsMaterialSection(item: GameCollectionItem): string {
...
function getBloxFruitsMaterialUse(item: GameCollectionItem): string | null {
...
function getBloxFruitsMaterialFarmRoute(item: GameCollectionItem): string | null {
...
function getBloxFruitsMaterialCraftCost(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name);
  if (name === "Volcanic Magnet") return "15 Blaze Ember + 10 Scrap Metal";
  return null;
}

function withBloxFruitsRaceFields(item: GameCollectionItem): GameCollectionItem {
  const name = normalizeValue(item.name) ?? "";
...
function withBloxFruitsBossFields(item: GameCollectionItem): GameCollectionItem {
  return {
    ...item,
    collectionSection: getBloxFruitsBossSection(item),
...
function getBloxFruitsBossSection(item: GameCollectionItem): string {
...
function getBloxFruitsBossRespawnAccess(item: GameCollectionItem): string | null {
...
function getBloxFruitsBossDropsRewards(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsBossRouteUse(item: GameCollectionItem): string | null {
...
function withBloxFruitsEnemyFields(item: GameCollectionItem): GameCollectionItem {
  return {
    ...item,
    collectionSection: getBloxFruitsEnemySection(item),
...
function getBloxFruitsEnemySection(item: GameCollectionItem): string {
  const sea = normalizeValue(item.sea)?.toLowerCase() ?? "";
...
function getBloxFruitsEnemySeaStage(item: GameCollectionItem): string | null {
...
function getBloxFruitsEnemyRegion(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsEnemyQuestSource(item: GameCollectionItem): string | null {
  const section = getBloxFruitsEnemySection(item);
  if (section === "Raid, sea event, and special enemies") return "Special encounter";
  return "Leveling route";
}

function getBloxFruitsEnemyDropsRewards(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsEnemyAccess(item: GameCollectionItem): string | null {
  const section = getBloxFruitsEnemySection(item);
...
function withBloxFruitsLocationFields(item: GameCollectionItem): GameCollectionItem {
...
function getBloxFruitsLocationDetails(item: GameCollectionItem) {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsLocationLevelRange(item: GameCollectionItem): string | null {
...
function withBloxFruitsQuestFields(items: GameCollectionItem[]): GameCollectionItem[] {
...
function withBloxFruitsSeaEventFields(item: GameCollectionItem): GameCollectionItem {
  const name = normalizeValue(item.name) ?? "";
...
function withBloxFruitsAbilityFields(item: GameCollectionItem): GameCollectionItem {
  const name = normalizeValue(item.name) ?? "";
...
function withBloxFruitsAuraStageFields(item: GameCollectionItem): GameCollectionItem {
  const stage = normalizeValue(item.stage ?? getBloxFruitsFieldValue(item, "stage")) ?? normalizeValue(item.name);
  return {
    ...item,
    name: `Stage ${stage}`,
    collectionSection: "Aura stage progression",
    displayStage: stage,
...
function withBloxFruitsAuraVisualFields(item: GameCollectionItem): GameCollectionItem {
  const stage = normalizeValue(item.stage ?? getBloxFruitsFieldValue(item, "stage")) ?? normalizeValue(item.name);
  return {
    ...item,
    name: `Stage ${stage}`,
    collectionSection: "Aura appearance stages",
    visualStage: stage,
...
function withBloxFruitsBoatFields(item: GameCollectionItem): GameCollectionItem {
  return {
    ...item,
    collectionSection: getBloxFruitsBoatSection(item),
...
function getBloxFruitsBoatSection(item: GameCollectionItem): string {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsBoatSourceAccess(item: GameCollectionItem): string | null {
...
function getBloxFruitsBoatSeaEventRole(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsBoatSpecialUse(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function withBloxFruitsGunFields(item: GameCollectionItem): GameCollectionItem {
  return {
    ...item,
    collectionSection: getBloxFruitsGunSection(item),
    displaySea: getBloxFruitsSeaLabel(item.sea),
...
function getBloxFruitsGunSection(item: GameCollectionItem): string {
  const seaNumbers = getBloxFruitsSeaNumbers(item.sea);
...
function getBloxFruitsGunSourceRoute(item: GameCollectionItem): string | null {
...
function getBloxFruitsGunCostOrDrop(item: GameCollectionItem): string | null {
  const route = normalizeValue(item.obtainment) ?? "";
...
function getBloxFruitsGunRequirementMastery(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsGunCombatRole(item: GameCollectionItem): string | null {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsGunUpgradeUse(item: GameCollectionItem): string | null {
  return normalizeValue(item.upgrading) ? "Blacksmith upgrade available" : null;
}

function withBloxFruitsInstinctLevelFields(item: GameCollectionItem): GameCollectionItem {
  const level = normalizeValue(item.level ?? getBloxFruitsFieldValue(item, "level")) ?? normalizeValue(item.name);
  return {
    ...item,
    name: `Level ${level}`,
    collectionSection: getBloxFruitsInstinctLevelSection(level),
    displayLevel: level,
...
function withBloxFruitsNpcFields(item: GameCollectionItem): GameCollectionItem {
...
function getBloxFruitsNpcDetails(item: GameCollectionItem) {
  const name = normalizeValue(item.name) ?? "";
...
function getBloxFruitsNpcAccessSpawn(item: GameCollectionItem, section: string): string | null {
  const spawnTime = normalizeValue(getBloxFruitsFieldValue(item, "spawnTime"));
  const despawnTime = normalizeValue(getBloxFruitsFieldValue(item, "despawnTime"));
  const parts: string[] = [];
...
function getBloxFruitsNpcCombat(item: GameCollectionItem): string | null {
...
function withBloxFruitsTitleFields(item: GameCollectionItem): GameCollectionItem {
...
function withBloxFruitsSpecialTitleFields(item: GameCollectionItem): GameCollectionItem {
  const obtainment = normalizeValue(item.obtainment ?? getBloxFruitsFieldValue(item, "obtainment")) ?? "";
  ...
  return {
    ...item,
    collectionSection: ownerAdmin ? "Owner and admin titles" : "Named account custom titles",
...
function withBloxFruitsTitleColorFields(item: GameCollectionItem): GameCollectionItem {
  const obtainment = normalizeValue(item.obtainment ?? getBloxFruitsFieldValue(item, "obtainment")) ?? "";
...
function getBloxFruitsFieldValue(item: GameCollectionItem, key: string): unknown {
...
function getAdoptMeEggSection(item: GameCollectionItem): string {
  const name = normalizeValue(item.name) ?? "";
...
function getAdoptMeToySection(item: GameCollectionItem): string {
  const name = normalizeValue(item.name) ?? "";
  const category = normalizeValue(item.category) ?? "";
...
function buildViewConfig(
  ...
  sectionOverride?: CollectionSectionOverride | null
): GenericViewConfig {
  ...
  const fieldPresentation = {
    ...(dataset.meta?.fieldPresentation ?? {}),
    ...(sectionOverride?.fieldPresentation ?? {})
  };
  ...
  return {
    ...
    label: config.label,
    groupKey,
    groupLabel: sectionOverride?.groupLabel ?? (groupKey === "collectionGroup" ? "Group" : getFieldLabel(groupKey)),
...
function withCollectionSectionOverride(
  config: GameCollectionConfig,
  dataset: GameCollectionDataset
): { dataset: GameCollectionDataset; sectionOverride: CollectionSectionOverride | null } {
...
function buildGameDatasetPreparedCollection(
  ...
  const { dataset: displayDataset, sectionOverride } = withCollectionSectionOverride(config, dataset);
