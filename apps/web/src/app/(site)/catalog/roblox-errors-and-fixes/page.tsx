...
import {
  ...
  renderRobloxErrorsPage,
  type CatalogContentHtml
} from "./page-data";

export const revalidate = 86400;

const CATALOG_CODE_CANDIDATES = ["roblox-errors-and-fixes"];
...
export default async function RobloxErrorsAndFixesPage() {
  const [{ items, meta }, { contentHtml }] = await Promise.all([
    loadRobloxErrorsPageData(),
    buildCatalogContent()
  ]);

  return renderRobloxErrorsPage({
    items,
