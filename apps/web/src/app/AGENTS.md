...
- Keep route files thin. Prefer `apps/web/src/lib/*` for database access and cross-route logic.
...
- For shared UI surfaces, prefer shadcn primitives from `apps/web/src/components/ui` and keep their composition simple.
...
- If you add a new public content type or route family, review:
  ...
  - the relevant route under `apps/web/src/app/sitemaps/`
