...
| Tower Defense Simulator wiki | `/wiki/tower-defense-simulator`, `/wiki/tower-defense-simulator/towers`, `/wiki/tower-defense-simulator/modes` | Generic wiki hub and collection routes backed by published database revisions; maps and enemies remain research-blocked and unregistered |
