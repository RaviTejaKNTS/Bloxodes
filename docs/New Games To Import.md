...
- Apply the `Add to Existing Rows` updates separately before or after the import script.
...
| --- | --- | --- | --- | --- | --- |
| 1 | Anime Hunters Simulator | `anime-hunters-simulator` | [Link](https://robloxden.com/game-codes/anime-hunters-simulator) |  | Add this source to the existing DB row instead of inserting a new game. |
| 2 | Liar's Table | `liar-s-table` | [Link](https://robloxden.com/game-codes/liars-table) | [Link](https://beebom.com/liars-table-codes/) | Add this source to the existing DB row instead of inserting a new game. |
| 3 | Ophelia | `ophelia` | [Link](https://robloxden.com/game-codes/ophelia) |  | Add this source to the existing DB row instead of inserting a new game. |
| 4 | RE:XL | `re-xl` | [Link](https://robloxden.com/game-codes/rexl) |  | Add this source to the existing DB row instead of inserting a new game. |
| 5 | Waste Time | `waste-time` | [Link](https://robloxden.com/game-codes/waste-time) |  | Add this source to the existing DB row instead of inserting a new game. |
